...
function theme_enqueue_styles() {
    ...
    */
    ...
    wp_enqueue_script( 'zarba-js', get_stylesheet_directory_uri() . '/js/zarba.js', array(), $the_theme->get( 'Version' ), true);
    ...
    wp_enqueue_style( 'zarba-css', get_stylesheet_directory_uri() . '/css/zarba.css', array(), $the_theme->get( 'Version' ) );
